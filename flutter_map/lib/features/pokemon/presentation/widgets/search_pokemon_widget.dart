...
class SearchPokemonWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    SelectedPokemonItemProvider selectedPokemonItem = Provider.of<SelectedPokemonItemProvider>(
      context,
    );
    return Padding(
        ...
        children: [
          Wrap(
            ...
            children: [
              ElevatedButton(
                onPressed: () {
                  selectedPokemonItem.changeNumber(newNumber: Random().nextInt(maxPokemonId));
                },
                                  ...
                                  child: SafeArea(
                                    ...
                                    child: CupertinoPicker(
                                      ...
                                      onSelectedItemChanged: (int selectedItem) {
                                        selectedPokemonItem.changeNumber(newNumber: selectedItem);
                                      },
                                      children: List<Widget>.generate(maxPokemonId, (int index) {
          ...
          CustomElevatedButtonWidget(
            ...
            callback: () async {
              ...
              if (await NetworkInfoImpl(InternetConnection()).isConnected == false) {
